package com.juanlabrador.library;
...
import com.juanlabrador.library.adapters.NumericWheelAdapter;
import com.juanlabrador.library.widget.OnWheelChangedListener;
import com.juanlabrador.library.widget.WheelView;
...
public class WheelDatePicker extends LinearLayout {
    ...
    public static class MonthsAdapter extends NumericWheelAdapter {
        ...
        public static boolean isLocaleSupported(Locale locale) {
            return  new Locale( "es", "ES" ).equals( locale ) || new Locale( "en", "US" ).equals( locale );
        }
